...
$(function () {
	...
	$("#layerCancel").click(function () {
		...
		window.location.href= "message.html?_pid=" + pid;
    });
...
function initTree(){
	...
	g_comboBoxTree.init($('#categoryId') , function (objNode, cb) {
		$.ajax({
		    url: top.app.conf.url.api.cdms.msg.category.getCategoryTree,
		    method: 'GET',
		    data: {
		    	access_token: top.app.cookies.getCookiesToken()
		    },success: function(data){
...
function initView(){
	...
	top.app.addComboBoxOption($("#isShopManage"), g_params.isShopManageDict);
...
function submitAction(){
	...
	submitData["organizerId"] = g_comboxOrganizerTree.getNodeId();
	submitData["categoryId"] = g_comboBoxTree.getNodeId();
	submitData["isShopManage"] =$("#isShopManage").val()
