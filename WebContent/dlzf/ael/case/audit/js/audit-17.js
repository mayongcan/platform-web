var g_params = {}, g_backUrl = null, g_counterpartType = "17";
...
function initData(){
	...
	if(!$.utils.isNull(dataInfo.content)){
		...
		$('#tdCaseParties').text($.utils.getNotNullVal(dataInfo.content.caseParties));
		...
		$('#tdPartiesContacts').text($.utils.getNotNullVal(dataInfo.content.partiesContacts));
		$('#tdPartiesAddress').text($.utils.getNotNullVal(dataInfo.content.partiesAddress));
		...
		$('#tdHearingDetail').text($.utils.getNotNullVal(dataInfo.content.hearingDetail));
		$('#tdMemo').text($.utils.getNotNullVal(dataInfo.content.memo));
		$('#tdSuggest').text($.utils.getNotNullVal(dataInfo.content.suggest));
	}
