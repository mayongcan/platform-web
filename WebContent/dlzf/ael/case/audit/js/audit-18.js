var g_params = {}, g_backUrl = null, g_counterpartType = "18";
...
function initData(){
	...
	if(!$.utils.isNull(dataInfo.content)){
		...
		$('#tdTotalCnt').text($.utils.getNotNullVal(dataInfo.content.totalCnt));
		$("input[type='radio'][name=handleType][value=" + dataInfo.content.handleType + "]").attr("checked",true);
