...
var g_codeType = rales.writOptional1_20, g_codeCurNum = "";
...
function initView(){
	...
	$("#btnPrint").click(function () {
		...
		top.app.layer.editLayer('预览', ['725px', '600px'], '/rales/ael/case/optional/writ-pre1_20.html', params, function(){});
    });
	//提交
...
function getTableParams(){
	...
	if(g_params.type == 1 || g_params.type == 2){		
		...
		data.CaseReason = $("#CaseReason").val();
		data.OtherName = $("#OtherName").val();
		data.OtherUnit = $("#OtherUnit").val();
		data.OtherJob = $("#OtherJob").val();
