...
function initTable(){
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/rales/clr/complaint/getFinishList",   		//请求后台的URL（*）
...
function btnEventView(id){
	...
	var url = "/rales/clr/complaint/complaint-view.html?_pid=" + pid + "&backUrl=/rales/clr/complaint/complaint-finish-list.html";
