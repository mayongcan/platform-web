...
function initTable(){
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/rales/clr/complaint/getHandleList",   		//请求后台的URL（*）
...
function btnEventView(id){
	...
	var url = "/rales/clr/complaint/complaint-view.html?_pid=" + pid + "&backUrl=/rales/clr/complaint/complaint-handle-list.html";
