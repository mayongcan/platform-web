...
//			   			'<div><span style="color:red;margin-right:30px;">' + g_knowData[i].sub[j].name + '</span>覆盖半径：<span>' + g_knowData[i].sub[j].serviceRadius + '</span>km</div>' + 
//					'</div>' + 
//					'<div style="clear:both"></div>';
//		}
		html += '<div style="position: relative;">' + 
					...
					'<div><span style="color:red;margin-right:30px;">' + g_knowData[i].statName + '</span>覆盖半径：<span>' + g_knowData[i].stServR + '</span>km</div>' + 
				'</div>' + 
				'<div style="clear:both"></div>';
		html +=    	'</div>' + 
		   		'</div>' + 
