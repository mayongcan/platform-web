	...
	option = {
	    ...
	    tooltip : {
	        ...
	        formatter: function (params, ticket, callback) {
	            return params.seriesName + "：[" + params.value[2] + "]" + "<br/>" + params.data.name + "：[东经=" + params.value[0]  + ", 北纬=" + params.value[1] + "]";
	        }
	    },
	    legend: {
	        orient: 'vertical',
...
function initBarCharts1(){
	...
	option = {
		    ...
		    series: [{
		        data: [1120, 2100, 1150, 180, 710, 1110, 1130, 1510, 810, 710, 910, 1410],
		        type: 'bar'
		    }]
		};
	charts.setOption(option);
