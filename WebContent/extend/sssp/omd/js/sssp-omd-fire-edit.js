...
function initView(){
	...
	if(g_params.type == "edit"){
		...
		$('#way').val(g_params.rows.way);
		$('#status').val(g_params.rows.status);
		$('#passMan').val(g_params.rows.passMan);
		$('#passTime').val(g_params.rows.passTime);
...
function submitAction(){
	...
	submitData["way"] = $("#way").val();
	submitData["status"] = $("#status").val();
	submitData["passMan"] = $("#passMan").val();
	submitData["passTime"] = $("#passTime").val();
