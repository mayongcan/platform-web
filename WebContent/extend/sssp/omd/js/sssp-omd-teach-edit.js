...
function initView(){
	...
	if(g_params.type == "edit"){
		$('#kind').val(g_params.rows.kind);
		$('#works').val(g_params.rows.works);
		$('#date').val(g_params.rows.date);
...
function submitAction(){
	...
	submitData["kind"] = $("#kind").val();
	submitData["works"] = $("#works").val();
	submitData["date"] = $("#date").val();
