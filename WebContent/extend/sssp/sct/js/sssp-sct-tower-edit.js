...
function initView(){
	...
	if(g_params.type == "edit"){
		...
		$('#forearmLength').val(g_params.rows.forearmLength);
		$('#longarmLength').val(g_params.rows.longarmLength);
		$('#towerCrane').val(g_params.rows.towerCrane);
		$('#towerCapHigh').val(g_params.rows.towerCapHigh);
		$('#height').val(g_params.rows.height);
		$('#ratedLiftingWeight').val(g_params.rows.ratedLiftingWeight);
...
function submitAction(){
	...
	submitData["forearmLength"] = $("#forearmLength").val();
	submitData["longarmLength"] = $("#longarmLength").val();
	submitData["towerCrane"] = $("#towerCrane").val();
	submitData["towerCapHigh"] = $("#towerCapHigh").val();
	submitData["height"] = $("#height").val();
	submitData["ratedLiftingWeight"] = $("#ratedLiftingWeight").val();
