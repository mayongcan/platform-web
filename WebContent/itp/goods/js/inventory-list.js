var $table = $('#tableList'), g_selectGoodsData = null;
...
function initTable(){
	...
	$table.bootstrapTable({
        //url: top.app.conf.url.apigateway + "/api/itp/goods/getGoodsInventoryList",   		//请求后台的URL（*）
...
function loadAllInfo(){
	...
	//加载库存列表
    $table.bootstrapTable('refresh', {"url": top.app.conf.url.apigateway + "/api/itp/goods/getGoodsInventoryList"});
}
...
function getStatisticsGoodsInventory(){
	$.ajax({
		url: top.app.conf.url.apigateway + "/api/itp/goods/getStatisticsGoodsInventory",
	    method: 'GET',
	   	data:{
	    	access_token: top.app.cookies.getCookiesToken(),
	    	goodsId: g_selectGoodsData.id
