...
function initView(){//判断是新增还是修改
	if(g_params.type == "edit"){
		...
		$('#type').val(g_params.node.data.type == undefined ? "" : g_params.node.data.type);
		$('#merchantsId').val(g_params.node.data.merchantsId == undefined ? "" : g_params.node.data.merchantsId);
