...
function initNavButton(){
	...
	$('#navDetail1').click(function () {
		...
		document.getElementById("sub-iframe").src="/itp/goods/itp-goods-info-detail-1.html";
    });
	$('#navDetail2').click(function () {
		...
		document.getElementById("sub-iframe").src="/itp/goods/itp-goods-info-detail-2.html";
    });
	$('#navDetail3').click(function () {
		...
		document.getElementById("sub-iframe").src="/itp/goods/itp-goods-info-detail-3.html";
    });
}
