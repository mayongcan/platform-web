...
function initGoodsColor(){
	$.ajax({
		url: top.app.conf.url.apigateway + "/api/itp/base/getColorInfoList",
		method: 'GET',
	    async: false,
	   	timeout:5000,
		data: {
...
function initGoodsSize(){
	$.ajax({
		url: top.app.conf.url.apigateway + "/api/itp/base/getSizeInfoList",
		method: 'GET',
	    async: false,
	   	timeout:5000,
		data: {
...
function initGoodsTexture(){
	$.ajax({
		url: top.app.conf.url.apigateway + "/api/itp/base/getTextureInfoList",
		method: 'GET',
	    async: false,
	   	timeout:5000,
		data: {
...
function loadGoodsInventoryDataList(goodsId){
	$.ajax({
		url: top.app.conf.url.apigateway + "/api/itp/goods/getGoodsInventoryList",
		method: 'GET',
		data: {
			access_token: top.app.cookies.getCookiesToken(),
            page: 0,
