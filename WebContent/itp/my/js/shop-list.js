...
function initFuncBtnEvent(){
	//绑定工具条事件
	$("#itpMyShopAdd").click(function () {
		//设置参数
		top.app.info.iframe.params = {};
		top.app.info.iframe.params.type = 'add';
		top.app.info.iframe.params.merchantsId = itp.getUserMerchantsId();
		top.app.info.iframe.params.operUrl = top.app.conf.url.apigateway + $("#itpMyShopAdd").data('action-url');
		var pid = $.utils.getUrlParam(window.location.search,"_pid");
		var url = "/itp/merchants/itp-shop-info-edit.html?_pid=" + pid + "&backUrl=/itp/my/shop-list.html";
