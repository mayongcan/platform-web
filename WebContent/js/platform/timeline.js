$.fn.timeline = function(data) {
    ...
    $(this).append(creataTimeline(data));
    //2.自适应
    ...
    function creataTimeline(data) {
        ...
        timeline.append(wrapper).append(prev).append(next).append(line);
        return timeline;
    };
    /**item添加样式，显示在上方或下方*/
