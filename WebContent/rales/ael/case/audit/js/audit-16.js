var g_params = {}, g_backUrl = null, g_counterpartType = "16";
...
function initData(){
	...
	if(!$.utils.isNull(dataInfo.content)){
		...
		$('#tdOrg').text($.utils.getNotNullVal(dataInfo.content.org));
		$('#tdSendDate').text($.utils.getNotNullVal(dataInfo.content.sendDate));
