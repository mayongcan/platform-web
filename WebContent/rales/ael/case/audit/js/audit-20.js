var g_params = {}, g_backUrl = null, g_counterpartType = "20";
...
function initData(){
	...
	if(!$.utils.isNull(dataInfo.content)){
		...
		$('#tdCaseCode').text($.utils.getNotNullVal(dataInfo.content.caseCode));
		...
		if(!$.utils.isEmpty(dataInfo.content.applyList)){
			var array = dataInfo.content.applyList.split(',');
