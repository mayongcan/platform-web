...
//            flowProgress: $('#searchFlowProgress').val(),
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/rales/ael/case/getCaseFinishList",   		//请求后台的URL（*）
...
function btnEventDetail(id){
	...
	var url = "/rales/ael/case/case-detail.html?_pid=" + pid + "&backUrl=/rales/ael/case/case-finish.html";
