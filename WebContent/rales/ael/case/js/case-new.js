...
function initDistrict(){
	...
	top.app.initDistrict($("#areaProvince"), $("#areaCity"), $("#areaDistrict"), '20,321,7043', false);
...
//		});
	...
	if(!$.utils.isNull(g_params) && !$.utils.isNull(g_params.routineRow)){
		...
		if(!$.utils.isNull(dataInfo.content)){
			...
			$("#defendantDate").val($.date.dateFormat(dataInfo.content.checkDate, "yyyy-MM-dd"));
			
			$("#clueSummary").val(dataInfo.content.checkContent);
		}
	}
