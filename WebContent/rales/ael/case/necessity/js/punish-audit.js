...
var g_codeType = "23", g_codeCurNum = "";
...
function initView(){
	$('#tdCaseCode').text(g_params.row.caseCode);
	...
	if(g_params.type == 1){
		...
		$('#caseIntro').val(g_params.subRow.introduction);
		...
		$('#tdCaseIntro').text($.utils.getNotNullVal(g_params.subRow.introduction));
...
function submitAction(){
	...
	var url = "";
	if(g_params.type == 2){
		url = top.app.conf.url.apigateway + "/api/rales/ael/case/editPunishAudit?access_token=" + top.app.cookies.getCookiesToken(),
		submitData["id"] = g_params.id;
	} else{
		url = top.app.conf.url.apigateway + "/api/rales/ael/case/addPunishAudit?access_token=" + top.app.cookies.getCookiesToken(),
		submitData["code"] = $('#tableTitleMark').text();
		submitData["codeCurNum"] = g_codeCurNum;
		submitData["registerId"] = g_params.row.id;
	}
	submitData["codeType"] = g_codeType;
	submitData["introduction"] = $('#caseIntro').val();
