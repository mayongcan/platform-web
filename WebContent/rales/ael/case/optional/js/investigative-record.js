...
//		g_codeCurNum = rales.showCodeCurNum(g_codeType);
		...
		$('#investigativeUser').val(g_params.row.createUserName + "、" + g_params.row.associateUserName);
...
//	   			if(data.rows.length == 0 && g_params.type == 2) addQuestion();
...
function formValidate(){
	$("#divEditForm").validate({
        rules: {
    		...
    		beInvestigativeIdCard: {required: true, isIdCardNo: true},
