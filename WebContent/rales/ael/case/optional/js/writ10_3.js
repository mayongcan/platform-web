...
var g_codeType = rales.writOptional10_3, g_codeCurNum = "";
...
function initView(){
	...
	if(g_params.type == 1){
		...
		if(!$.utils.isNull(g_params.subRow.content)){
			...
			if(g_params.subRow.content.caseInfo == '1') $("#caseInfo").attr("checked",true);
//			$('#baseRule').val(g_params.subRow.content.baseRule);
			$('#handleDate').val(g_params.subRow.content.handleDate);
			$('#handleType').val(g_params.subRow.content.handleType);
...
//			$('#tdBaseRule').text($.utils.getNotNullVal(g_params.subRow.content.baseRule));
			...
			$('#tdHandleType').text($.utils.getNotNullVal(g_params.subRow.content.handleType));
...
function getTableParams(){
	...
	if(g_params.type == 1 || g_params.type == 2){	
		...
		var caseInfo = '0'
		if($('#caseInfo').prop('checked')) caseInfo = '1';
