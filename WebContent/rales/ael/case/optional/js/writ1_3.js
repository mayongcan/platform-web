...
var g_codeType = rales.writOptional1_3, g_codeCurNum = "";
var g_dataList = [];
$(function () {
...
function initView(){
	...
	$("#btnPrint").click(function () {
		...
		top.app.layer.editLayer('预览', ['725px', '600px'], '/rales/ael/case/optional/writ-pre1_3.html', params, function(){});
    });
	//提交
	...
	$("#btnAdd").click(function () {
		...
		var params = {};
		params.type= "add";
		top.app.layer.editLayer('新增涉案物品', ['710px', '400px'], '/rales/ael/case/optional/writ1_3-edit.html', params, function(retParams){
...
function btnEventEdit(index){
	...
	top.app.layer.editLayer('编辑涉案物品', ['710px', '400px'], '/rales/ael/case/optional/writ1_3-edit.html', params, function(retParams){
		if(retParams == null || retParams == undefined && retParams.length > 0) {
			top.app.message.alert("获取返回内容失败！");
			return;
		}
