...
var g_codeType = rales.writOptional3_5, g_codeCurNum = "";
...
function initView(){
	...
	if(g_params.type == 1){
		...
		if(!$.utils.isNull(g_params.subRow.content)){
			...
			$('#placeAddr').val(g_params.subRow.content.placeAddr);
		...
		if(!$.utils.isNull(g_params.subRow.content)){
			...
			$('#tdPlaceAddr').text($.utils.getNotNullVal(g_params.subRow.content.placeAddr));
	...
	$("#btnPrint").click(function () {
		...
		top.app.layer.editLayer('预览', ['725px', '600px'], '/rales/ael/case/optional/writ-pr3_5.html', params, function(){});
    });
	//提交
	...
	$("#btnPreview").click(function () {
		...
		var params = {};
		params.data = getTableParams();
		top.app.layer.editLayer('预览', ['725px', '600px'], '/rales/ael/case/optional/writ-pre3_5.html', params, function(){});
    });
	//返回
