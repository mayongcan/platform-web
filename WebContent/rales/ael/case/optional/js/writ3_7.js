...
var g_codeType = rales.writOptional3_7, g_codeCurNum = "";
...
function initView(){
	...
	if(g_params.type == 1){
		...
		if(!$.utils.isNull(g_params.subRow.content)){
			...
			$('#tdMeasureType').text($.utils.getNotNullVal(g_params.subRow.content.content));
			$('#tdContent').text($.utils.getNotNullVal(g_params.subRow.content.measureType));
	...
	$("#btnPrint").click(function () {
		...
		top.app.layer.editLayer('预览', ['725px', '600px'], '/rales/ael/case/optional/writ-pr3_7.html', params, function(){});
    });
	//提交
	...
	$("#btnPreview").click(function () {
		...
		var params = {};
		params.data = getTableParams();
		top.app.layer.editLayer('预览', ['725px', '600px'], '/rales/ael/case/optional/writ-pre3_7.html', params, function(){});
    });
	//返回
