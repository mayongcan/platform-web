...
function initTable(){
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/rales/ael/force/getFinishList",   		//请求后台的URL（*）
...
function btnEventDetail(id){
	...
	var url = "/rales/ael/force/audit-detail.html?_pid=" + pid + "&backUrl=/rales/ael/force/audit-finish-list.html";
