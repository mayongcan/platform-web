...
function initNavButton(){
	...
	$('.nav-detail li').hover(function () {
		...
		}else if(this.id == 'navDetail5' && g_navIndex == 5){
		}else {
	...
	$('#navDetail1').click(function () {
		...
		$('#navDetail5 span').css('background', '#d4d4d4');
		$('#navDetail1 a').css('color', '#000');
		$('#navDetail2 a').css('color', '#666');
		$('#navDetail3 a').css('color', '#666');
		$('#navDetail4 a').css('color', '#666');
		$('#navDetail5 a').css('color', '#666');
		
		document.getElementById("case-iframe").src="/rales/ael/routine/form-1.html";
    });
	$('#navDetail2').click(function () {
		...
		document.getElementById("case-iframe").src="/rales/ael/routine/form-2.html";
    });
	$('#navDetail3').click(function () {
		...
		document.getElementById("case-iframe").src="/rales/ael/routine/form-3.html";
    });
	$('#navDetail4').click(function () {
		...
		document.getElementById("case-iframe").src="/rales/ael/routine/form-4.html";
    });
	$('#navDetail5').click(function () {
		g_navIndex = 5;
		$('#navDetail1 span').css('background', '#d4d4d4');
		$('#navDetail2 span').css('background', '#d4d4d4');
		$('#navDetail3 span').css('background', '#d4d4d4');
		$('#navDetail4 span').css('background', '#d4d4d4');
		$('#navDetail5 span').css('background', '#1FAEFF');
		$('#navDetail1 a').css('color', '#666');
		$('#navDetail2 a').css('color', '#666');
		$('#navDetail3 a').css('color', '#666');
		$('#navDetail4 a').css('color', '#666');
		$('#navDetail5 a').css('color', '#000');
		
		document.getElementById("case-iframe").src="/rales/ael/routine/form-5.html";
    });
	...
	setTimeout(function () {
		...
		else if(navIndex == 4) $('#navDetail4').trigger("click");
		else if(navIndex == 5) $('#navDetail5').trigger("click");
    }, 300);
}
