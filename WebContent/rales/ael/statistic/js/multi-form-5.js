...
$(function () {
	...
	g_dict = top.app.getDictDataByDictTypeValue('AEL_PUNISH_IMPLTYPE');
	//获取权限菜单
	initFunc();
	//初始化列表信息
	initTable();
...
function initTable(){
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/rales/ael/statistic/getStatisticPunishTypeList",   		//请求后台的URL（*）
