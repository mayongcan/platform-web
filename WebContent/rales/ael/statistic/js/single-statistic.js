...
$(function () {
	initView();
	//实现日期联动;
	$.date.initSearchDate('divBegin', 'divEnd');
});
...
function initFuncBtnEvent(){
	...
	$("#btnReset").click(function () {
		...
		$("#searchEnd").val("");
		$("#searchYear").val("");
		$("input:radio[name=radioSearchTime]")[2].checked = true;;
		//刷新数据，否则下拉框显示不出内容
		$('.selectpicker').selectpicker('refresh');
		loadIframe();
    });
...
function loadIframe(){
	if(g_navIndex == '1'){
		document.getElementById("case-iframe").src="/rales/ael/statistic/single-form-1.html";
	}else if(g_navIndex == '2'){
		document.getElementById("case-iframe").src="/rales/ael/statistic/single-form-2.html";
	}else if(g_navIndex == '3'){
		document.getElementById("case-iframe").src="/rales/ael/statistic/single-form-3.html";
	}else if(g_navIndex == '4'){
		document.getElementById("case-iframe").src="/rales/ael/statistic/single-form-4.html";
	}else if(g_navIndex == '5'){
		document.getElementById("case-iframe").src="/rales/ael/statistic/single-form-5.html";
	}
}
