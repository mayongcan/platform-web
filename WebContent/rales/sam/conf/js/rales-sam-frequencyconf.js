...
function initFuncBtnEvent(){
	...
	$("#ralesSamFrequencyconfAdd").click(function () {
		...
		top.app.layer.editLayer('新增频率规划维护', ['710px', '460px'], '/rales/sam/conf/rales-sam-frequencyconf-edit.html', params, function(){
   			//重新加载列表
			$table.bootstrapTable('refresh');
		});
    });
...
function ralesSamFrequencyconfEdit(id, url){
	...
	top.app.layer.editLayer('编辑频率规划维护', ['710px', '460px'], '/rales/sam/conf/rales-sam-frequencyconf-edit.html', params, function(){
			//重新加载列表
		$table.bootstrapTable('refresh');
	});
}
