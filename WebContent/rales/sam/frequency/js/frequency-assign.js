...
function initView() {
    ...
    $("#btnPdf3").click(function () {
        var array = g_dataObj.pdfPath3.split(',');
...
//                var dataPath = g_dataObj.pdfPath2;
//                for (var i = 0; i < dataPath.length; i++) {
//                    var html = '<tr>' +
//                        '<td class="reference-td" style="text-align: center;">' + $.utils.getNotNullVal(dataPath[i].stationName) + '</td>' +
//                        '<td class="reference-td" style="text-align: center;">' + $.utils.getNotNullVal(dataPath[i].stationAddr) + '</td>' +
//                        '<td class="reference-td" style="text-align: center;">' + $.utils.getNotNullVal(dataPath[i].freq) + '</td>' +
//                        '</tr>';
//                    $('#passiveresultList').append(html);
//                }
//                dataPath = g_dataObj.pdfPath3;
//                for (var i = 0; i < dataPath.length; i++) {
//                    var html = '<tr>' +
//                        '<td class="reference-td" style="text-align: center;">' + $.utils.getNotNullVal(dataPath[i].stationName) + '</td>' +
//                        '<td class="reference-td" style="text-align: center;">' + $.utils.getNotNullVal(dataPath[i].stationAddr) + '</td>' +
...
//                }
                ...
                if ($.utils.isEmpty(g_dataObj.errorInfo)) {
                    ...
                    //重新加载数据
                    loadView();
                    top.app.layer.editLayer('报告结果', ['900px', '550px'], '/rales/sam/frequency/frequency-assign-result.html', g_dataObj, function (retParams) {
