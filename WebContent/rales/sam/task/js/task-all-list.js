...
function initTable(){
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/rales/sam/task/getTaskList",   		//请求后台的URL（*）
...
function btnEventView(id){
	...
	var url = "/rales/sam/task/task-view.html?_pid=" + pid + "&backUrl=/rales/sam/task/task-all-list.html";
