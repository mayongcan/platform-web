...
//            expensesName: $("#searchExpensesName").val(),
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/scms/finance/getDailyExpensesList",   		//请求后台的URL（*）
...
function initFuncBtnEvent(){
	//绑定工具条事件
	$("#scmsDailyExpensesAdd").click(function () {
		//设置参数
		var params = {};
		params.type = 'add';
		params.operUrl = top.app.conf.url.apigateway + $("#scmsDailyExpensesAdd").data('action-url');
		top.app.layer.editLayer('新增日常支出', ['710px', '460px'], '/scms/finance/scms-daily-expenses-edit.html', params, function(){
   			//重新加载列表
			$table.bootstrapTable('refresh');
		});
    });
...
function scmsDailyExpensesEdit(id, url){
	...
	top.app.layer.editLayer('编辑日常支出', ['710px', '460px'], '/scms/finance/scms-daily-expenses-edit.html', params, function(){
			//重新加载列表
		$table.bootstrapTable('refresh');
	});
}

function scmsDailyExpensesDel(id, url){
