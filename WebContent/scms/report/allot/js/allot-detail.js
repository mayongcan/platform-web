...
function initSearchPanel(){
	...
	var shopList = scms.getUserMerchantsId();
	scms.getShopPullDown($("#searchSrcShopId"), shopList, true);
	scms.getShopPullDown($("#searchDestShopId"), shopList, true);
...
function initTable(){
	...
	$table.bootstrapTable({
        url: top.app.conf.url.apigateway + "/api/scms/report/getAllotReportDetailList",   		//请求后台的URL（*）
